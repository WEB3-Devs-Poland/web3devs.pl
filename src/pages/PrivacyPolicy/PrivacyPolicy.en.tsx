...
export const PrivacyPolicyEN = () => (
  <S.PrivacyPolicy>
    <h1>Privacy Policy for WEB3 Devs Poland</h1>
    <p>
      At Web3 Poland Sp.zo.o., accessible from https://web3devs.pl/, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types of information that
      is collected and recorded by Web3 Poland Sp.zo.o. and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in Web3 Poland
      Sp.zo.o.. This policy is not applicable to any information collected offline or via channels
    ...
    <h2>Log Files</h2>
    <p>
      Web3 Poland Sp.zo.o. follows a standard procedure of using log files. These files log visitors
    ...
    <p>
      Like any other website, Web3 Poland Sp.zo.o. uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on Web3 Poland
      Sp.zo.o., which are sent directly to users' browser. They automatically receive your IP
    ...
    <p>
      Note that Web3 Poland Sp.zo.o. has no access to or control over these cookies that are used by
      third-party advertisers.
    </p>
    <h2>Third Party Privacy Policies</h2>
    <p>
      Web3 Poland Sp.zo.o.'s Privacy Policy does not apply to other advertisers or websites. Thus,
    ...
    <p>
      Web3 Poland Sp.zo.o. does not knowingly collect any Personal Identifiable Information from
